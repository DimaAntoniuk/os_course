...
DROP TABLE IF EXISTS antoniuk_db.panel;
DROP TABLE IF EXISTS antoniuk_db.panel_data;
...
CREATE TABLE antoniuk_db.panel (
  id INT NOT NULL AUTO_INCREMENT,
...
ALTER TABLE panel
	ADD INDEX fk_panel_station1_idx (station_id ASC) VISIBLE,
  ADD CONSTRAINT fk_panel_station1
    FOREIGN KEY (station_id)
    REFERENCES antoniuk_db.station (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
ALTER TABLE panel_data
	ADD INDEX fk_panel_data_panel1_idx (panel_id ASC) VISIBLE,
  ADD CONSTRAINT fk_panel_data_panel1
    FOREIGN KEY (panel_id)
    REFERENCES antoniuk_db.panel (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
INSERT INTO station (number_of_panels, address, time_of_usage)
VALUES
...
INSERT INTO panel (`type`, `capacity`, station_id)
VALUES
